...
I en statistisk undersökning vill vi uttala oss om egenskaper i en **population** med observationer i ett **stickprov**
</div>
...
<div class="fragment fade-in">
**Hypotestest** är en metod för att dra *statistiskt säkerställda* slutsatser om populationens egenskaper
</div>
...
Om man har en känd populationsstandardavvikelse $\sigma$ baseras konfidensintervallet på normalfördelningen
...
vilket vi kan beräkna till $(29.93, 42.07)$
</div>
