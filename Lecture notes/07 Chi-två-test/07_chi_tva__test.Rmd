...
ggplot(dat, aes(x, y)) + 
  ...
  geom_hline(yintercept = 0) +
  ylab("f(x)") +
  labs(title = expression(chi^2*"-fördelning, k - m - 1 fg")) +
...
$$\chi^2 = \sum_{\text{alla celler}} \frac{(O_{ij} - E_{ij})^2}{E_{ij}} = \frac{(9 - 11.5)^2}{11.5} + \cdot \cdot \cdot + \frac{(77 - 81)^2}{77} = 6.381$$
</div>
